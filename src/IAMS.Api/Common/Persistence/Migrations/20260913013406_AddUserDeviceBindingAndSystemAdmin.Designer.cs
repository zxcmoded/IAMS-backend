...
namespace IAMS.Api.Common.Persistence.Migrations
{
    ...
    [Migration("20260913013406_AddUserDeviceBindingAndSystemAdmin")]
    partial class AddUserDeviceBindingAndSystemAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAMS.Api.Common.Domain.UserDeviceBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserDeviceBindings", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserDeviceBindings_Status", "[Status] IN ('Active', 'Reset')");
                        });
                });
            ...
            modelBuilder.Entity("IAMS.Api.Common.Domain.UserDeviceBinding", b =>
                {
                    b.HasOne("IAMS.Api.Common.Domain.User", "ResetByUser")
                        .WithMany()
