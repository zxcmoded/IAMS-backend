        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Channel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    SharedSecret = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectiveFromUtc = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompanyConnectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FilterType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FilterValue = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyConnectionFilters_CompanyConnections_CompanyConnectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActiveCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActiveLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsTwoFactorComplete = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ScopeLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ScopeWarehouseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ScopeRackId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ScopeBinId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PermissionLevelOverride = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CompanyConnectionScopes_CompanyConnections_CompanyConnectionId",
                        column: x => x.CompanyConnectionId,
                        principalTable: "CompanyConnections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true)
                .Annotation("SqlServer:Include", new[] { "IsEnabled", "PermissionLevel", "ConnectionType", "PolicyRevision" });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "CompanyConnectionId")
                .Annotation("SqlServer:Include", new[] { "Level", "ScopeCompanyId", "ScopeLocationId", "ScopeWarehouseId", "ScopeRackId", "ScopeBinId", "PermissionLevelOverride" });
